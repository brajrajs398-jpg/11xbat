  ...
  switch (type) {
    case 'straight':
      ...
      if (value !== undefined && value === winningNumber) {
        multiplier = 36; // 35:1 odds -> 36x total return (stake + 35x profit)
        won = true;
      }
      break;
    ...
    case 'street':
      ...
      if (value !== undefined) {
        ...
        if (street && street.includes(winningNumber)) {
          multiplier = 12; // 11:1 odds -> 12x total return
          won = true;
        }
      }
      break;
    ...
    case 'sixline':
      ...
      if (value !== undefined) {
        ...
        if (sixline && sixline.includes(winningNumber)) {
          multiplier = 6; // 5:1 odds -> 6x total return
          won = true;
        }
      }
      break;
    ...
    case 'column':
      ...
      if (value !== undefined) {
        ...
        if (col === (betCol === 3 ? 0 : betCol - 1)) {
          multiplier = 3; // 2:1 odds -> 3x total return
          won = true;
        }
      }
      break;
    ...
    case 'dozen':
      ...
      if (value !== undefined) {
        // 2:1 odds -> 3x total return (stake + 2x profit)
    ...
    case 'red':
      ...
      if (ROULETTE_RED_NUMBERS.has(winningNumber)) {
        multiplier = 2; // 1:1 odds -> 2x total return
        won = true;
      }
      break;
