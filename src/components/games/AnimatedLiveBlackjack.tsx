...
export default function AnimatedLiveBlackjack({ game, onBack }: { game: CatalogGame; onBack: () => void }) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      <div className="relative overflow-hidden rounded-2xl border-4 border-amber-900/60 bg-gradient-to-b from-emerald-950 via-emerald-900 to-emerald-950 p-6 shadow-2xl min-h-[360px] flex flex-col justify-between">
