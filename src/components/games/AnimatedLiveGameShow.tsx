...
export default function AnimatedLiveGameShow({ game, onBack }: { game: CatalogGame; onBack: () => void }) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      <div className="relative overflow-hidden rounded-2xl border-4 border-fuchsia-900/60 bg-gradient-to-b from-fuchsia-950 via-purple-950 to-black p-6 text-center shadow-2xl">
