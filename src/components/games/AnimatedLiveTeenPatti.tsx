...
export default function AnimatedLiveTeenPatti({ game, onBack }: { game: CatalogGame; onBack: () => void }) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      <div className="relative overflow-hidden rounded-2xl border-4 border-amber-900/60 bg-gradient-to-b from-amber-950 via-zinc-900 to-black p-6 text-center shadow-2xl min-h-[320px] flex flex-col justify-between">
